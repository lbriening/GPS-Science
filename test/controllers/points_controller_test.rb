...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { latitude: @point.latitude, longitude: @point.longitude, time_recorded: @point.time_recorded }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { latitude: @point.latitude, longitude: @point.longitude, time_recorded: @point.time_recorded }
    assert_redirected_to point_path(assigns(:point))
  end
