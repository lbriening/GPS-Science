...
class DaysControllerTest < ActionController::TestCase
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post :create, day: { pressure: @day.pressure, temperature: @day.temperature, test_date: @day.test_date, weather_condition: @day.weather_condition }
    end
  ...
  test "should update day" do
    patch :update, id: @day, day: { pressure: @day.pressure, temperature: @day.temperature, test_date: @day.test_date, weather_condition: @day.weather_condition }
    assert_redirected_to day_path(assigns(:day))
  end
